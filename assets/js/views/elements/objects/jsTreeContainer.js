...
/*			        {
	...
	jsTreeBreadcrumb(){
            ...
            this.breadcrumbTargetDiv.append('<a id="bc_'+node.id+'" style="margin-left:10px" class="waves-effect waves-light  btn gradient-45deg-light-blue-cyan box-shadow-none border-round mr-1">'+node.text+'</a>');
         	...
         	//parsing des parents
         	 for (let k in node.parents){
				...
				if(parentNode.text !== undefined){
					...
					this.breadcrumbTargetDiv.prepend('<a href="#!" id="bc_'+parentNode.id+'" style="margin-left:10px" class="waves-effect waves-light  btn gradient-45deg-light-blue-cyan box-shadow-none border-round mr-1">'+parentNode.text+'</a>');
