...
/*
		...
		let qry = "UPDATE NotesDatas SET status = 'UPLOADING' WHERE status = 'BEFOREUP' AND timestamp = '"+this.DatasToSend.timestamp+"'' AND item_path = '"+this.DatasToSend.item_path+"'";
		this.webSQL.playQuery('syncUp',qry);
