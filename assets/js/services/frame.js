...
export default class Frame {
	...
	constructor(){
		...
		this.app = new PIXI.Application(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio, { backgroundColor : 0xD8D8D8, antialias : true });  // Add the view to the DOM 		
